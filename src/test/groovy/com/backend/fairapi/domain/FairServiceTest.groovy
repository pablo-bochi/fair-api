...
import com.backend.fairapi.Fixture
import com.backend.fairapi.core.exception.InvalidInputException
import com.backend.fairapi.core.exception.ResourceAlreadyExistsException
import com.backend.fairapi.core.exception.ResourceNotFoundException
...
class FairServiceTest extends Specification {
    ...
    @Shared com.backend.fairapi.presentation.dto.FairPartialDTO partialDTO = Fixture.partialDTO()
